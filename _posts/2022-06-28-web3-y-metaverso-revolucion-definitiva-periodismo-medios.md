...
¿Qué ventajas tiene esto, además de facilitar un modelo de organización cooperativista y descentralizado versus la alta jerarquización actual de los medios? [Larry](https://coloradosun.com/author/larry-ryckman/) [Ryckman](https://coloradosun.com/author/larry-ryckman/), director del Colorado Sun (uno de los diarios que se unió a Civil), destacaba en su momento os de esos beneficios: “Proporciona una gran seguridad para nuestro contenido, garantiza una mayor **transparencia** para nosotros y para nuestros lectores y facilita que los estos puedan apoyar directamente a Colorado Sun y a sus periodistas”.
...
[Forefront](https://forefront.market/), por su parte, es un proyecto de contenido que evita la etiqueta de ‘medio’. Sobre la creencia de que “las comunidades tokenizadas pueden revolucionar los marcos en torno al dinero, el valor y la coordinación, marcando el comienzo de la economía de propiedad y creación de Web3” pretende ser el centro de contenido y comunidad de dicho espacio. Publica un podcast, un boletín semanal y contenido en su blog, además de ofrecer recursos. Al igual que Water & Music, recompensa a los contribuyentes con su propio su token.
