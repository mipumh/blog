...
![]({{ site.baseurl }}/images/001/ur_lilla_aktuellt_skola_studion_2021.jpg)
<sup>Desde el estudio de la cadena SVT, el programa Lilla Aktuellt se emite en directo todos los viernes. Foto: Jonas Eng
...
![]({{ site.baseurl }}/images/001/an-example-of-an-svd-junior-edition.png)
...
![]({{ site.baseurl }}/images/001/svd_junior_header-1200x675-1.png)
