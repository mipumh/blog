...
![image alt text]({{ site.baseurl }}/images/001/aura_IA_0.png)
<span style="display:block; margin-top:.4rem; font-size:.85em; line-height:1.2;">© Lauren McCarthy</span>

**El trabajo pesado es todo aquello que consume tiempo y recursos**. La IA ya es extraordinaria para ayudarnos en eso: recolectar grandes volúmenes de datos, detectar patrones en imágenes, transcribir horas de audio, traducir entrevistas, geolocalizar archivos, limpiar bases de datos, generar visualizaciones o escribir código [sin saber programar](https://mip.umh.es/blog/2026/01/09/bajando-la-barrera-del-codigo-en-la-redaccion-programacion-asistida-con-ia/). Todo eso acelera la producción periodística. Pero ninguna de esas tareas, por sí sola, produce buen periodismo. Solo crea nuestra materia prima.

**El valor aparece cuando entra el trabajo pensado**: la idea de partida, la pregunta bien formulada, el ángulo original, la verificación, la edición con criterio, la decisión de qué es relevante y qué no. La IA puede ayudar a procesar información, pero no decide por qué una historia merece ser contada ni qué significa para una comunidad. Como decía el[ profesor José Alberto García Avilés](https://jagarciaaviles.substack.com/p/instrucciones-para-innovar?utm_source=publication-search), "el algoritmo te puede decir qué titulares se comparten más, pero no sabe qué titular conseguirá que un ministro no duerma esta noche".

La IA es un fenómeno global epistémico, no una simple herramienta, que está transformando la cultura y la mentalidad profesional. Lo podemos comprobar en la recopilación que Patricia Ventura[ ha hecho de casi 400 casos de uso de la IA](https://www.patriciaventura.me/single-post/casos-de-uso-de-inteligencia-artificial-en-medios-de-comunicaci%C3%B3n) en medios de todo el mundo. Se trata de una carga de profundidad que afecta al criterio informativo, a la creatividad profesional, a la jerarquía informativa o al negocio.

En muchas redacciones se utiliza como [herramienta de apoyo](https://mip.umh.es/blog/2025/12/02/superpoderes-para-los-periodistas-la-ia-en-politiken-dinamarca/) (resúmenes, traducciones, transcripciones, análisis de datos o detección de tendencias) lo que sugiere una **inclinación al ahorro de tiempo y a la optimización del trabajo pesado**. Al mismo tiempo, aparecen usos más creativos que revelan un desplazamiento desde tareas repetitivas hacia aplicaciones con mayor potencial narrativo y analítico.

![image alt text]({{ site.baseurl }}/images/001/aura_IA_1.png)
<span style="display:block; margin-top:.4rem; font-size:.85em; line-height:1.2;">© Paolo Cirio</span>
...
![image alt text]({{ site.baseurl }}/images/001/aura_IA_2.png)
<span style="display:block; margin-top:.4rem; font-size:.85em; line-height:1.2;">© Trevor Paglen</span>
